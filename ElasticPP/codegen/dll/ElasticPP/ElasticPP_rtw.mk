###########################################################################
## Makefile generated for MATLAB file/project 'ElasticPP'. 
## 
## Makefile     : ElasticPP_rtw.mk
## Generated on : Tue Mar 10 00:30:13 2020
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: ./ElasticPP.dll
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/23752/Documents/GitHub/HS-Material-Models/ElasticPP/codegen/dll/ElasticPP
ARCH                      = win64
TGT_FCN_LIB               = ISO_C
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = ElasticPP_rtw_comp.rsp
CMD_FILE                  = ElasticPP_rtw.rsp
...
DEFINES_ = -D__USE_MINGW_ANSI_STDIO=1 -DMODEL=ElasticPP -DHAVESTDIO -DUSE_RTMODEL
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=ElasticPP -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/ElasticPP_initialize.c $(START_DIR)/ElasticPP_terminate.c $(START_DIR)/ElasticPP.c
...
OBJS = ElasticPP_initialize.obj ElasticPP_terminate.obj ElasticPP.obj
...
%.obj : C:/Users/23752/Documents/GitHub/HS-Material-Models/ElasticPP/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : C:/Users/23752/Documents/GitHub/HS-Material-Models/ElasticPP/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
